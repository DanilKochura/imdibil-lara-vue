                ...
                <div class="bg-dark border-0 card shadow-light-md-hover ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly">
                            <x-medal class=" fill-brown w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 60%"></x-medal>
                            <x-medal class="  fill-gray-200 w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 80%"></x-medal>
                            <x-medal class="  fill-warning w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 95%"></x-medal>
                        </div>
                    </div>
            ...
            <div class="col-sm-3 mb-2">
                <div class="bg-dark border-0 card shadow-light-md-hover ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-evenly">
                            <x-medal class=" fill-inactive fill-brown w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 60%"></x-medal>
                            <x-medal class=" fill-inactive fill-gray-200 w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 80%"></x-medal>
                            <x-medal class=" fill-inactive fill-warning w-25" data-bs-toggle="tooltip" data-bs-placement="top" title="Пройдено 95%"></x-medal>
                        </div>
                    </div>
                    <div class="card-footer text-muted">
